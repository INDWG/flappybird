package com.example.st10060590_opsc7312_ice_task_1
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var hurtSound: MediaPlayer
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize MediaPlayer for background music and jump sound
        mediaPlayer = MediaPlayer.create(this, R.raw.background_music)
        mediaPlayer.isLooping = true
        mediaPlayer.start()

        jumpSound = MediaPlayer.create(this, R.raw.jump)
        hurtSound = MediaPlayer.create(this, R.raw.hurt)
